...
import 'package:food/modules/Details_Screens/DessertDetails_Screen/DessertDetails_Screen.dart';
...
class dessertScreen extends StatelessWidget {
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                            onTap: (){
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context)=>DessertDetails(
                                    model: cubit.dessertList,index: index,))
                              );
                            } ,
                            child: DessertItem(cubit.dessertList[index],context,index)
                        );
                      },
  ...
  Widget DessertItem(foodModel model ,context,index) {
    return Column(
      children: [
        Align(
          ...
          children: [
            Row(
              children: [
                ...
                IconButton(
                    onPressed: (){
                      RecipeCubit.get(context).changeDessertFavourite(
                          RecipeCubit.get(context).dessertId[index],
                          model.favourite!
                      );
                    },
