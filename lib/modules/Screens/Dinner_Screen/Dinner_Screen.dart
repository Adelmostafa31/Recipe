...
import 'package:food/modules/Details_Screens/DinnerDetails_Screen/DinnerDetails_Screen.dart';
...
class dinnerScreen extends StatelessWidget {
                    ...
                    return InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => DinnerDetails(
                                      model: cubit.dinnerList, index: index)));
                        },
                        child: DinnerItem(cubit.dinnerList[index], context,index));
                  },
                  itemCount: cubit.dinnerList.length,
  ...
  Widget DinnerItem(foodModel model, context,index) {
    return Column(
      children: [
        Align(
          ...
          children: [
            Row(
              children: [
                ...
                IconButton(
                    onPressed: (){
                      RecipeCubit.get(context).changeDinnerFavourite(
