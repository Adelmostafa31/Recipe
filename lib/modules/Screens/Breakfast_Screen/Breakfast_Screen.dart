...
import 'package:food/modules/Details_Screens/BreakfastDetails_Screen/BreakfastDetails_Screen.dart';
...
class breakfastScreen extends StatelessWidget {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => BreakfastDetails(
                                      model: cubit.breakfastList,
                                      index: index)));
                        },
                        child: BreakfastItem(
                            cubit.breakfastList[index], context, index));
                  },
                  itemCount: cubit.breakfastList.length,
  ...
  Widget BreakfastItem(foodModel model, context, index) {
    return Column(
      children: [
        Align(
          ...
          children: [
            Row(
              children: [
                ...
                IconButton(
                    onPressed: () {
                      RecipeCubit.get(context).changeBreakfastFavourite(
                          RecipeCubit.get(context).breakfastId[index],
                          model.favourite!);
                    },
